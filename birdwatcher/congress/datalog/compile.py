...
from birdwatcher.congress import data_types
from birdwatcher.congress.datalog import analysis
from birdwatcher.congress.datalog import base
from birdwatcher.congress.datalog import builtin
...
if six.PY2:
    ...
    from birdwatcher.congress.datalog.Python3 import CongressLexer
    from birdwatcher.congress.datalog.Python3 import CongressParser
import antlr3

from birdwatcher.congress.datalog import utility
from birdwatcher.congress import exception
from birdwatcher.congress import utils
    ...
    def update(self, item, is_insert):
        ...
        if is_insert:
            ...
            if tablename not in self:
                LOG.warning("Attempt to delete a nonexistent rule: %s", item)
